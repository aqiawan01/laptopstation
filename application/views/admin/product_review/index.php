                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $product_review->fullname; ?></td>
                                <td><?php echo $product_review->email; ?></td>
                                <td>
                                <?php if ($product_review->status ==  'DEACTIVE') :  ?>
                                    <a class="singleStatus" href="/admin/product_review/status/<?php echo $product_review->id; ?>"><span class="label label-important">Deactive!</span>
                                    <?php else: ?>
                                    <a class="singleStatus" href="/admin/product_review/status/<?php echo $product_review->id; ?>"><span class="label label-info">Active!</span>
                                <?php endif ?>
                                <td>
